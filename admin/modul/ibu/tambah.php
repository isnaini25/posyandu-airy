                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-validation">
                                    <form class="form-valide" action="../admin/modul/ibu/aksi_simpan.php" method="post">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="nama" name="namaIbu" placeholder="Enter a nama..">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="suami" name="namaSuami" placeholder="Name Your Husband ..">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="date" class="form-control" id="tglPendaftaran" name="tglPendaftaran">
                                            </div>
                                        </div>
                                        </div>
                                        <div class="form-group row">
