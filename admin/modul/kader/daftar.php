                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-validation">
                                    <form class="form-valide" action="../admin/modul/kader/aksi_simpan.php" method="post">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="nama" name="nama" placeholder="Enter a nama..">
                                            </div>
                                        </div>
                                        <div class="form-group row">
